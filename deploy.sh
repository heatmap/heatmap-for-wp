...
# main config
PLUGINSLUG="heatmap-for-wp"
CURRENTDIR=`pwd`
MAINFILE="heatmap-for-wp.php" # this should be the name of your main php file in the wordpress plugin
...
SVNUSER="heatmap" # your svn username
